...
const plants = {
	...
	Орхідеї: {
		...
		51: {
			...
			price: 1200,
			img: 'https://plantsroom.com.ua/wp-content/uploads/2024/07/img_8956-scaled.jpg',
			flowerSize: '40',
			isFlowering: true,
		...
		52: {
			...
			price: 600,
			img: 'https://ukraflora.ua/image/cache/catalog/image/cache/catalog/content/gorschechka/kambrija_1stovbur_kaskad_1-1100x1100.webp',
			flowerSize: '60',
			isFlowering: true,
		...
		53: {
			id: 530,
			name: 'Кімнатна рослина Фаленопсіс плямистий 12x70',
			price: 800,
			img: 'https://lorashen.ua/static/media/uploads/product/Rasteniya/.thumbnails/img_9315.jpg/img_9315-0x600.jpg',
			flowerSize: '70',
			isFlowering: true,
		...
		54: {
			...
			price: 950,
			img: 'https://paeonia.com.ua/image/cache/catalog/products/9594/additional3-800x800.webp',
			flowerSize: '70',
			isFlowering: true,
		...
		55: {
			id: 25,
			name: 'Рослина Фаленопсіс 1 стовбур Royal Blue 12x60 см',
			price: 2600,
			img: 'https://www.pattiflora.it/cdn/shop/products/phaleno_blu_pattiflora_1200x1200.jpg?v=1645106668',
			flowerSize: '60',
			isFlowering: true,
	...
	'Екзотичні кімнатні рослини': {
		60: {
			id: 600,
			name: 'Банан кімнатний Супер карлик плодовий 10-21 см',
			price: 1500,
			img: 'https://yaskravaklumba.com.ua/image/cache/catalog/derevya/1_ekzotika/banankomnatnyjkievskijsuperkarlik2-500x500.jpg',
			flowerSize: '21',
			isFlowering: false,
			desc: "Банан кімнатний Супер карлик - це компактна рослина, яка відрізняється невеликими розмірами і привабливим виглядом. Цей плодовий банан ідеально підходить для домашнього вирощування, адже при належному догляді може давати невеликі, але смачні плоди. Рослина має зелене листя, що додає свіжості вашому інтер'єру. Догляд за ним не є складним: потрібно забезпечити достатнє освітлення і регулярний полив.",
			conditionsСare:
				'Банан кімнатний Супер карлик потребує яскравого, розсіяного світла, помірного поливу та родючого субстрату для оптимального росту та розвитку.',
			light: true,
			temperature: '+20...+28',
			watering: 'помірний',
		},
		61: {
			id: 610,
			name: 'Мірт домашній Гостролистий 21-30 см',
			price: 1800,
			img: 'https://cdn.27.ua/sc--media--prod/default/54/67/fb/5467fb24-8ce1-439f-a4db-eedce98acacc.jpeg',
			flowerSize: '30',
			isFlowering: true,
		...
		62: {
			...
			price: 1200,
			img: 'https://faterra.com/img/banner/ananas.jpg',
			flowerSize: '10',
			isFlowering: false,
		...
		63: {
			id: 630,
			name: 'Лімонелла сорт Пурша 11-20 см',
			price: 1600,
			img: 'https://cdn.27.ua/sc--media--prod/default/e8/63/d5/e863d5fc-bf6b-42fb-a408-a708adcd9e05.jpeg',
			flowerSize: '20',
			isFlowering: true,
		...
		64: {
			...
			price: 1900,
			img: 'https://i.pinimg.com/564x/d9/7b/cd/d97bcd0cc0e660d2f6d7f30a6deff799.jpg',
			flowerSize: '30',
			isFlowering: true,
		...
		65: {
			id: 650,
			name: 'Розмарин 11-20 см',
			price: 1200,
			img: 'https://cactus.by/sites/default/files/products/img_9788.jpg',
			flowerSize: '20',
			isFlowering: true,
	...
	Флораріуми: {
		70: {
			id: 700,
			name: 'Флораріум з орхідеєю в куполі Красуня 40 см',
			price: 3000,
		...
		71: {
			id: 710,
			name: 'Флораріум з деревом Бонсаєм Magic Gardens 25х12 см',
			price: 2500,
		...
		72: {
			id: 720,
			name: 'Флораріум з сукулентами та імітацією водойми 10 см',
			price: 1800,
		...
		74: {
			id: 740,
			name: 'Міні-флораріум Крапля 9х9 см',
			price: 800,
